...
class Embeds {
    static green = 2817792;
    static red = 16711680;
    static neutral = 7803166;
    ...
    static level(user, xp, totalXp, level) {
        return this.template("Level " + level, [{
                "name": "Progress",
                "value": `\`${xp}/${totalXp}\`\n\`${Util_1.Util.createProgressBar(xp, totalXp, 15)}\``,
                "inline": true
            }], this.neutral, user);
    }
    static levelUp(user, level, rewards) {
        return this.template("Level Up", [{
                "name": "Info",
                "value": `Congratulations on leveling up to **level ${level}**!\n${Util_1.Util.formatRewards(rewards)}!`,
                "inline": false
            }], this.neutral, user);
    }
    static added(fields, currency, amount, user, reason) {
    ...
    static removed(fields, currency, amount, user, reason) {
    ...
    static entry(currency, amount, symbol = "") {
        return {
            "name": Util_1.Util.capitalize(currency),
