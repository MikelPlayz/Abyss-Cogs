...
import { Interaction, Client, ClientEvents, Snowflake, Message, AutocompleteInteraction, ChatInputCommandInteraction, ContextMenuCommandInteraction, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, ChannelType, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, ChatInputApplicationCommandData, UserApplicationCommandData, MessageApplicationCommandData, ApplicationCommandManager, Collection, ApplicationCommand, PermissionsBitField, CommandInteraction, TextBasedChannel, PermissionResolvable, ClientOptions, Events as Events$1, PermissionsString, Guild, PartialDMChannel } from 'discord.js';
...
declare namespace index {
  export {
    ...
    index_resolveGuild as resolveGuild,
