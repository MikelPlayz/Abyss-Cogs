...
function actionIsButtonOrMenu(action) {
    return (action.type === discord_js_1.ComponentType.Button ||
        action.type === discord_js_1.ComponentType.StringSelect ||
        action.type === discord_js_1.ComponentType.UserSelect ||
        action.type === discord_js_1.ComponentType.RoleSelect ||
        action.type === discord_js_1.ComponentType.MentionableSelect ||
        action.type === discord_js_1.ComponentType.ChannelSelect);
}
