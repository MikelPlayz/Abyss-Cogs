...
class DailyCommand extends framework_1.Command {
    constructor(context, options) {
        super(context, Object.assign(Object.assign({}, options), { "name": "daily", "preconditions": ["IsValidChannel"], "cooldownDelay": 86400000, "description": "Rewards up to three credits and gold every day." }));
    }
    ...
    chatInputRun(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return interaction.reply({ "embeds": [Embeds_1.Embeds.daily(fields, interaction.user)] }).then();
        });
    }
}
