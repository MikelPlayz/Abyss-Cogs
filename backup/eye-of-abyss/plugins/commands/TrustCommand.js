...
exports.TrustCommand = void 0;
const framework_1 = require("@sapphire/framework");
const Embeds_1 = require("../../Embeds");
const Main_1 = require("../../Main");
class TrustCommand extends framework_1.Command {
    constructor(context, options) {
        super(context, Object.assign(Object.assign({}, options), { "name": "trust", "description": "Executes the /trust command.", "preconditions": ["PluginEnabled"] }));
    }
    ...
    chatInputRun(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Main_1.minecraftBot.chat(`/trust ${username}`);
