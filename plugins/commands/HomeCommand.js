...
exports.HomeCommand = void 0;
const framework_1 = require("@sapphire/framework");
const Embeds_1 = require("../../Embeds");
const Main_1 = require("../../Main");
class HomeCommand extends framework_1.Command {
    constructor(context, options) {
        super(context, Object.assign(Object.assign({}, options), { "name": "home", "description": "Executes the /home command.", "preconditions": ["PluginEnabled"] }));
    }
    ...
    chatInputRun(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Main_1.minecraftBot.chat(`/home ${name}`);
