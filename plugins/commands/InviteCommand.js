...
class InviteCommand extends framework_1.Command {
    constructor(context, options) {
        super(context, Object.assign(Object.assign({}, options), { "name": "invite", "description": "Executes the /team invite command.", "preconditions": ["PluginEnabled"] }));
    }
    ...
    chatInputRun(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Main_1.minecraftBot.chat(`/team invite ${username}`);
